...
$$E_d$$——存在效价或存在度(E Degree)；

$$C_d$$——代偿效价或代偿度(Compensation Degree)；
...
同时，递弱代偿原理，是必要条件，而非充分条件。意味着对于复杂的问题，不可能有简单的解，同时解也必须恰到好处。过度代偿的多样性，相当于用力过猛，超过必要的多样性必将反过来作用于自身而产生新的副作用，引其新的不确定性。这实际上是一个闭环反馈的过程，控制论能比较好地描述这个迭代过程。
